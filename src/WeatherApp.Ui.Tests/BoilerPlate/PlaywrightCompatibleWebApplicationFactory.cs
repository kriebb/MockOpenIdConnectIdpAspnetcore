            ...
            builder.ConfigureWebHost(webHostBuilder => webHostBuilder.UseKestrel(options =>
                ...
                configuration =>
                {
                    ...
                    configuration.AddInMemoryCollection(new List<KeyValuePair<string, string>>()
                    {
                        ...
                        new("WeatherApp:TemperatureAPIBaseUrl",$"https://{_WeatherappApiDependencyHost}:{_WeatherAppApiDependencyPort}/"),
                        new("WeatherApp:TemperatureDirectUrl",$"https://{_WeatherappApiDependencyHost}:{_WeatherAppApiDependencyPort}/"),
